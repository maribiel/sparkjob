package maribiel.sparkjob.casandra
...
object CassandraConfig {
  ...
  var uberTransactionTable:String = _
  ...
  def load() = {
    ...
    uberTransactionTable = Config.applicationConf.getString("config.cassandra.table.uber.transaction")
  ...
  def defaultSettng() = {
    ...
    uberTransactionTable = "uber_transaction"
