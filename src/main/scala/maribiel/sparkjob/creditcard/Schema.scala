...
object Schema {
    ...
    val uberStructureName = "uberSource"

    val uberSchema = new StructType()
      .add(Enums.UberSource.time, TimestampType,true)
      .add(Enums.UberSource.lat, DoubleType,true)
      .add(Enums.UberSource.lon, DoubleType,true)
      .add(Enums.UberSource.base, StringType,true)

    val IHSSourceStructureName = "IHSSource"

    val IHSSourceSchema = new StructType()
      .add(Enums.IHSSource.IHS_MEASURE, StringType,true)
      .add(Enums.IHSSource.IHS_COUNTRY, StringType,true)
      .add(Enums.IHSSource.IHS_YEAR, StringType,true)
      .add(Enums.IHSSource.IHS_VALUE, StringType,true)
